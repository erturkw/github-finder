          ...
          <div className="col-md-3">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p>
                  <a className='btn d-grid btn-dark btn-sm' href={html_url}>Github Profile</a>
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-9">
            <div className="card">
              <div className="card-body">
                ...
                <div>
                  <span className="badge bg-dark m-1">Followers: {followers}</span>
                  <span className="badge bg-dark m-1">Following: {following}</span>
                  <span className="badge bg-dark m-1">Repos: {public_repos}</span>
                </div>
